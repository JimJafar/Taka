...
(function() {
     ...
     * @constructor
     */
    Taka.vehicles.formations.V5 = function(shipType, startFrame, x, y) {
        this.Super(shipType, startFrame, x, y);
    };
    Taka.extend(Taka.vehicles.formations.V5, Taka.vehicles.formations.Formation);

    /**
     * Spawns the formation at the specified frame number
     * @param {Number} frame The frame number
     */
    Taka.vehicles.formations.V5.prototype.update = function(frame) {
