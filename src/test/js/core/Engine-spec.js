...
describe('Taka.core.Engine', function() {
    ...
    describe('Pause methods', function() {
        beforeEach(function() {
            spyOn(Taka.core.Timer, 'stop').andCallFake(function() { return null; });
            spyOn(Taka.core.Timer, 'start').andCallFake(function(canvas) { return canvas; });
        });
    ...
    describe('private methods', function() {
        ...
        it('should update the player', function() {
            spyOn(player, 'update');
            spyOn(player, 'getBullet').andCallThrough();
            engine.Update(42);
        ...
        it('should update the collisions', function() {
            spyOn(Taka.utils.BoxUtil, 'Intersect').andCallThrough();
            spyOn(player, 'hit');
            spyOn(player, 'dead');
            spyOn(enemy1, 'hit');
            spyOn(enemy1, 'dead');
            ...
            expect(Taka.utils.BoxUtil.Intersect.calls[0].args[0].name).toBe('enemy1');
            expect(Taka.utils.BoxUtil.Intersect.calls[0].args[1].name.substr(0, 7)).toBe('pBullet');
            ...
            expect(Taka.utils.BoxUtil.Intersect.calls[2].args[0].name).toBe('player');
            expect(Taka.utils.BoxUtil.Intersect.calls[2].args[1].name.substr(0, 7)).toBe('eBullet');
